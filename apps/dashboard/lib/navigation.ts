import {
  ...
  Phone, CalendarDays, BarChart3, PackageCheck, UserCheck, MessageSquare,
  type LucideIcon,
} from "lucide-react";
...
export const navigation: NavItem[] = [
  ...
  { label: "Drivers",     href: "/drivers",     icon: UserCheck,        emoji: "🧑‍✈️", description: "Manage your in-house delivery drivers" },
  { label: "Reviews",     href: "/reviews",     icon: MessageSquare,    emoji: "⭐", description: "Monitor and respond to customer reviews" },
